...
var latestBlock = 0;
var initialBlock = 0;
export async function avg30ServiceStart(numberOfBlocks: number) {
...
export async function getAvg30EstimatedGas() {
    average = fee/totalBaseTransations;
    return { "initialBlockNumber":initialBlock,"minBlockNumber":latestBlock, "averageFeeEstimate": average, "totalTransactionCount": totalTransations, "baseCurrencyTransactionsCount": totalBaseTransations, "totalBaseGasPrice": fee};
  }
